...
override fun getConnection(): Connection =
    ...
    override fun getGeneratedKeys(): ResultSet = createEmptyResultSet()
    ...
    /**
     * Returns an empty ResultSet suitable for getGeneratedKeys().
     */
    private fun createEmptyResultSet(): ResultSet {
        // Minimal implementation: return an empty PaginatedResultSet or similar stub.
        // For now, just use PaginatedResultSet with empty data.
        return object : ResultSet by PaginatedResultSet(
            originalSql = "",
            wsdlEndpoint = wsdlEndpoint,
            username = username,
            password = password,
